...
describe('utils', () => {
  describe('#getEtherscanLink', () => {
    ...
    it('ropsten', () => {
      expect(getEtherscanLink(3, 'abc', 'address')).toEqual('https://exp.c4ei.net/address/abc')
    })
    it('enum', () => {
      expect(getEtherscanLink(ChainId.RINKEBY, 'abc', 'address')).toEqual('https://exp.c4ei.net/address/abc')
    })
  })
