...
const ifos: Ifo[] = [
  ...
  },
  {
    ...
    description:
      'Ditto is the first elastic supply token on the C4EI. Its goal is to maintain a stable price of $1, where its supply will adapt to changes in demand. All supply changes will apply equally to every wallet holding Ditto, and holders should always have the same % of the total supply',
    launchDate: 'Dec. 23',
    launchTime: '3PM SGT',
  ...
  },
  {
    ...
    isActive: true,
    name: 'Soteria',
    subTitle: 'A blockchain based mutual to share the risk of DeFi on C4EI',
    description:
