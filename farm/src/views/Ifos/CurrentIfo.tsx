      ...
      <LaunchIfoCallout>
        <div>
          ...
          <Flex mb="16px">
            ...
            <LinkExternal href="https://exchange.pancakeswap.finance/#/add/ETH/0x1A10F46a2902078d8a1edB576FdAF8CB9B125d69">
        ...
        <div>
          ...
          <div>
            ...
            <Text mb={3}>
              {TranslateString(
                514,
                'Launch your project with PancakeSwap, C4EI’s most-used AMM project and liquidity provider, to bring your token directly to the most active and rapidly growing community on BSC.',
              )}
            </Text>
            <Button
              as="a"
